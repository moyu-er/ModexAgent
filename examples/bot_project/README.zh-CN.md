...
| **多级记忆** | Session / Archive / Core Memory / Pruned / Experience — 支持 UserScope / GlobalScope / SessionScope 可配置隔离范围 |
...
│ 短期会话  │→ │ 历史归档  │→ │ Memory    │  │ 淘汰目录  │  │EXPERIENCE │
│ (自动清理)│  │ (压缩存储) │  │ SOUL.md   │  │ (注入参考) │  │.md 文件   │
└───────────┘  └───────────┘  │ USER.md   │  └───────────┘  └───────────┘
                              │ MEMORY.md │
                              └───────────┘
```
