...
class TestShouldCleanup:
    ...
    def test_last_is_assistant_without_tool_calls(self) -> None:
        policy = ToolCallCleanupPolicy()
        msgs = [
    ...
    def test_last_is_assistant_with_tool_calls(self) -> None:
        policy = ToolCallCleanupPolicy()
        msgs = [
    ...
    def test_last_is_tool_message(self) -> None:
        policy = ToolCallCleanupPolicy()
        msgs = [
    ...
    def test_last_is_user_message(self) -> None:
        policy = ToolCallCleanupPolicy()
...
class TestClean:
    ...
    def test_removes_tool_and_intermediate_assistant(self) -> None:
        policy = ToolCallCleanupPolicy()
        msgs = [
    ...
    def test_preserves_user_and_agent_messages(self) -> None:
        policy = ToolCallCleanupPolicy()
        msgs = [
    ...
    def test_no_cleanup_when_turn_not_complete(self) -> None:
        policy = ToolCallCleanupPolicy()
        msgs = [
            _msg("user", content="run"),
            _msg(
    ...
    def test_multi_tool_call_chain_cleaned(self) -> None:
        policy = ToolCallCleanupPolicy()
        msgs = [
    ...
    def test_handles_empty_tool_calls(self) -> None:
