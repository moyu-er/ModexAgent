...
_DEFAULT_COMPACTABLE_TOOLS: frozenset[str] = frozenset({
    "read_file",
    "shell",
    "list_dir",
    "edit_file",
...
class MicrocompactGovernance(ContextGovernance):
    ...
    def __init__(
        ...
        self._compactable = compactable_tools if compactable_tools is not None else _DEFAULT_COMPACTABLE_TOOLS
