...
# =========================================================================
# Temporary compatibility shims — will be removed in Phase 7 cleanup
# =========================================================================
...
class TurnResumeState:
    """DEPRECATED: Use ``ReActTurnState`` + ``TurnSnapshot`` instead."""
    iteration: int
...
class TurnResumeStateStore(ABC):
    """DEPRECATED: Use ``TurnStateStore`` instead."""
    @abstractmethod
...
class InMemoryTurnResumeStateStore(TurnResumeStateStore):
    """DEPRECATED: Use ``InMemoryTurnStateStore`` instead."""
...
class StateStoreTurnResumeStateStore(TurnResumeStateStore):
    """DEPRECATED: Use ``TurnStateStore`` + ``ReActRuntimeStateCodec`` instead."""
