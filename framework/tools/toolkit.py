...
from ..core.constants import DefaultValues, ErrorMessages
from .registry import ToolRegistry
from .types import ToolDefinition, ToolFunction, infer_parameters_from_function
...
class Toolkit:
    ...
    def add_functions(
        ...
        *,
        ...
        metadatas: list[ToolMetadata | None] | None = None,
    ...
    def to_litellm_format(self, tool_names: list[str] | None = None) -> list[dict[str, Any]]:
        """转换为LiteLLM格式"""
