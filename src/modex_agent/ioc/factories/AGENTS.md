...
| `descriptors.py` | `build_subagent_descriptor(...)` — builds `AgentDescriptor` + tool_manager + skill_manager for subagents; contains standard tool builders (file, shell, search tools) |
