...
class ExternalAgentBuilder:
    """Fluent constructor for :class:`ExternalAgent`.
    ...
    def __init__(self) -> None:
        ...
        # no child capture, behavior unchanged; see ExternalAgent).
    ...
    def with_spec(self, spec: ExternalEnvSpec) -> ExternalAgentBuilder:
        self._spec = spec
        return self

    def with_base_env(self, env: dict[str, str]) -> ExternalAgentBuilder:
        self._base_env = env
        return self

    def with_model(self, model: str) -> ExternalAgentBuilder:
        self._model = model
        return self

    def with_thinking_level(self, level: str) -> ExternalAgentBuilder:
        self._thinking_level = level
        return self

    def with_timeout(self, timeout: float) -> ExternalAgentBuilder:
        self._timeout = timeout
        return self

    def with_child_discovery_sink(self, sink: ChildSessionDiscoverySink) -> ExternalAgentBuilder:
        self._child_discovery_sink = sink
        return self

    def with_session_registry(self, registry: SessionRegistry) -> ExternalAgentBuilder:
        self._session_registry = registry
        return self

    def with_session_id_factory(self, factory: SessionIdFactory) -> ExternalAgentBuilder:
    ...
    def build(self) -> ExternalAgent:
        ...
        if missing:
            raise ValueError(
                "ExternalAgentBuilder missing required collaborators: " + ", ".join(missing)
            )
    ...
    def build_agent(
        ...
        *,
        ...
        if missing:
            raise ValueError(
                "ExternalAgentBuilder.build_agent missing required "
