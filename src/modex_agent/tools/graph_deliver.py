                ...
                targets.append(
                    GraphDeliverTarget(
                        ...
                        description=(
                            ...
                            "- Respond to the Origin Request: the `[Origin Request]` in your "
                            "conversation context is the user's input. Your deliver is the "
                            "user's answer — match its form (answer, instruction, result).\n"
                            "- Do NOT use Task/Status/Done fields — write natural prose, not a "
                            "node-handoff report.\n"
