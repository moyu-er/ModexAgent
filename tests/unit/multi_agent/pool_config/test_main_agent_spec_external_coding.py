...
class TestMainAgentSpecExecutionStrategy:
    ...
    def test_accepts_external_coding(self) -> None:
        spec = MainAgentSpec(agent_name="main", execution_strategy="external_coding")
        assert spec.execution_strategy == "external_coding"
