"""Factory builder routing for execution_strategy = external_coding."""
...
class TestFactoryExternalCodingBuilder:
    def test_external_coding_returns_external_builder(self) -> None:
        factory = DefaultAgentFactory(default_llm_provider=MagicMock())
        builder = factory._get_builder("external_coding")
        assert builder is ExternalCodingAgentBuilder
